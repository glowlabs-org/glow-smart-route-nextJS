...
const en: BigDialogsStrings = {
  impactBreakdown: {
    ...
    activationBonus: "Referral Active",
    activationAwardedDesc: "Earning your share",
  ...
  referralNetwork: {
    ...
    activationBonus: "Referral Active",
    activationAwarded: (date) => `Activated ${date}`,
...
const ko: BigDialogsStrings = {
  impactBreakdown: {
    ...
    activationBonus: "추천 활성화",
    activationAwardedDesc: "분배 적립 중",
  ...
  referralNetwork: {
    ...
    activationBonus: "추천 활성화",
    activationAwarded: (date) => `${date} 활성화됨`,
...
const zh: BigDialogsStrings = {
  impactBreakdown: {
    ...
    activationBonus: "推荐已激活",
    activationAwardedDesc: "正在赚取分成",
  ...
  referralNetwork: {
    ...
    activationBonus: "推荐已激活",
    activationAwarded: (date) => `${date} 已激活`,
