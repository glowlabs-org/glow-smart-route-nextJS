...
const zh: BigDialogsStrings = {
  impactBreakdown: {
    ...
    pointSources: "点数来源",
    steeringPower: "引导力",
    steeringSubValue: "已质押 GCTL（3 倍点数）",
    stake: "质押",
    boost: "加成",
    emissions: "释放量",
    emissionsSubValue: (glw) => `${glw} GLW × 每周 1 点`,
    emissionsFallback: "GLW 释放奖励",
    earn: "赚取",
    add: "添加",
    delegation: "委托",
    delegationSubValue: (glw) => `${glw} GLW × 每周 0.005 点`,
    delegationFallback: "金库奖励",
    delegate: "委托",
    glowWorth: "Glow 资产",
    glowWorthSubValue: (glw) => `${glw} GLW × 每周 0.001 点`,
    glowWorthFallback: "持有 GLW",
    buy: "购买",
    ...
    extraPoints: "释放量、引导、金库奖励和 Glow 资产",
  ...
  referralNetwork: {
    ...
    helpBuildFuture: "携手共建太阳能源未来,赚取影响力点数。",
    ...
    faqActivationABold: "关联后 100 影响力点数",
    faqActivationABody2:
  ...
  mintStake: {
    ...
    boostImpactScoreDesc: "在排行榜上每引导 1 GLW 获得 3 点。",
    selectRegion: "选择地区",
    ...
    pointsGained: (amount) => `+${amount} 已获得`,
    perWeekShort: "/周",
  },
