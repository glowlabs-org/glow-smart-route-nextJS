...
const zh: RoutesStrings = {
  gctlLanding: {
    ...
    benefitSteeredHeader: "每引导 1 GLW +3 分",
    benefitSteeredDesc: "提升您的每周影响力分数",
    ...
    statBoostAmount: "3 倍",
    statBoostLabel: "影响力积分",
    statBoostDescDesktop1: "每引导 1 GLW",
    statBoostDescDesktop2: "至您的地区",
    statBoostDescMobile: "每引导 1 GLW",
    heroAlt: "工人与太阳能板",
  },
  miningCenter: {
    title: "矿工中心",
  ...
  impactLeaderboard: {
    ...
    fastestBoost: "最快提升",
    buyGlwHeadline: "购买 GLW 立刻开始赚取积分",
    buyGlwDesc:
      "购买 GLW 会增加 GlowWorth,为您的分数持续添加价值积分。",
    buyGlw: "购买 GLW",
    ...
    steeringDesc: "用质押的 GCTL 引导,每 GLW 获得 3 倍积分。",
    stakeGctl: "质押 GCTL",
    delegateGlwHeadline: "委托 GLW (排放 + 金库奖励)",
    delegateGlwDesc:
      "委托 GLW 开始赚取排放与金库奖励积分。",
    delegateGlw: "委托 GLW",
