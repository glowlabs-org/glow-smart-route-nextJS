export const LumaSpinner = () => {
  // Added accessible role and aria-label, switched to rounded-full for perfect circle, and ensured spans fill their parent using inset-0.
  return (
    <div
      role="status"
      aria-label="Loading"
