  ...
  switch (item.kind) {
    ...
    case "watts": {
      ...
      return {
        ...
        blurb:
          "Redeem points for farm-backed watts. The watts are the main thing; the associated impact comes with them, including Tons of CO₂ today and the Solar Footprint equivalents they power.",
        stats: [
          {
