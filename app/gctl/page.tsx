          ...
          <div className="lg:flex-1 flex flex-col lg:justify-center max-w-md py-0 lg:py-0">
            ...
            <div className="space-y-3 mb-6 sm:mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm font-medium">
                    {g.benefitSteeredHeader}
                  </div>
                  <div className="text-xs text-muted-foreground">
                    {g.benefitSteeredDesc}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm font-medium">{g.benefitFundHeader}</div>
                  <div className="text-xs text-muted-foreground">
                    {g.benefitFundDesc}
                  </div>
                </div>
              ...
              <div className="flex justify-center gap-6 sm:gap-12 lg:gap-24">
                <div className="text-center text-white">
                  ...
                  <div className="text-[10px] sm:text-xs lg:text-sm text-white/80 hidden sm:block">
                    {g.statSteeredDescDesktop1}
                    <br />
                    {g.statSteeredDescDesktop2}
                  </div>
                  <div className="text-[10px] text-white/80 sm:hidden">
                    {g.statSteeredDescMobile}
                  </div>
                </div>
                ...
                <div className="text-center text-white">
                  ...
                  <div className="text-[10px] sm:text-xs lg:text-sm text-white/80 hidden sm:block">
                    {g.statBoostDescDesktop1}
                    <br />
                    {g.statBoostDescDesktop2}
                  </div>
                  <div className="text-[10px] text-white/80 sm:hidden">
                    {g.statBoostDescMobile}
                  </div>
                </div>
              </div>
            </div>
