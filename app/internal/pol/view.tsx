...
const POL_COPY = {
  ...
  zh: {
    clickForBasics: "点击查看基础内容 ↗",
    clickForNotes: "点击查看说明 ↗",
    clickToExplore: "点击探索 ↗",
    liveUnavailable: "实时数据不可用",
    open: "打开 ↗",
    overview: "总览",
    openGlowEconomy: "打开 Glow 经济模型",
    marketCap: "市值",
    glwPrice: "GLW 价格",
    poolActivity: "资金池活动 ↗",
    embeddedLiquidity: "内嵌流动性",
    liquidityUnitValue: `1${LIQUIDITY_UNIT} 价值`,
    oneLiquidityUnit: "1 个流动性单位",
    monthlySolarConstruction: "月度太阳能建设",
    embeddedLiquidityGrowth3m: "内嵌流动性增长(3 个月)",
    annualizedCirculatingGrowth: "流通供应量年化增长",
    embeddedLiquidityGrowthMom: "内嵌流动性增长",
    mom: "环比",
    supplyAndCirculation: "供应量与流通",
    openSupplyModel: "打开供应模型探索器",
    circulatingSupply: "流通供应量",
    circulating: "流通中",
    vaulted: "已锁仓",
    embeddedGlw: "内嵌 GLW",
    exploreSupplyModel: "探索供应模型",
    solarFarmEconomics: "太阳能电站经济性",
    sortBy: "排序方式",
    latest: "最新",
    lifetime: "累计",
    ccPerWeek: "CC / 周",
    seeAll: "查看全部",
    generatedRevenue: "已产生收入",
    lifetimeProgress: "累计进度",
    embeddedLiquidityGctlWallets: "内嵌流动性、GCTL、钱包",
    openProtocolLiquidityNotes: "打开协议流动性说明",
    liquidity: "流动性",
    apy: "APY",
    marketCapExitable: "可退出市值占比",
    openGctlNotes: "打开 GCTL 说明",
    totalGctl: "GCTL 总量",
    mintPrice: "铸造价格",
    staked: "已质押",
    unstaked: "未质押",
    stakingByRegion: "按区域质押",
    openWalletStatsNotes: "打开钱包统计说明",
    walletStats: "钱包统计",
    glwHolders: "GLW 持有者",
    protocolParticipants: "协议参与者",
    newWalletsPerWeek: "每周新增钱包",
    walletBreakdown: "钱包构成",
    walletBreakdownLabels: {
      Delegators: "委托人",
      Miners: "矿工",
      "GCTL holders": "GCTL 持有者",
    } as Record<string, string>,
    delegationRegions: "委托与区域",
    openDelegationNotes: "打开委托指标说明",
    delegationMetrics: "委托指标",
    glwDelegated: "已委托 GLW",
    delegators: "委托人",
    estimatedApy: "预估 APY",
    delegationGrowth: "委托增长 (V2)",
    current: "当前",
    delegated: "已委托",
    delegationRatio: "委托比率",
    openRegionRevenueNotes: "打开各区域协议收入说明",
    perRegionRevenue: "各区域协议收入",
    region: "区域",
    threeMonth: "3 个月",
    farms: "电站",
    ...
    glwTotal: "GLW 总量",
    fdvHelperAt: "价格基准",
    embeddedUsdc: "内嵌 USDC",
    glwPriceLower: "GLW 价格",
    reset: "重置",
    priceHistory: "价格历史 ↗",
    coreMetrics: "核心指标",
    growthDetailsDesc: "增长卡片详情和迷你博客。",
    protocolLiquidity: "协议流动性",
    noRegionSelected: "未选择区域。",
    fallbackCc: "回退至 CC / 周",
    shareOfTotal: "占总量比例",
    totalPds: "PD 总数",
    farmDetailsDesc: "太阳能电站详情与收入统计。",
    selectFarmDetails: "请选择电站以查看详情。",
    panels: "块面板",
    creditType: "积分类型",
    generatedCreditsLifetime: "已产生积分(累计)",
    projectedLifetimeCredits: "预计累计积分",
    numberOfPanels: "面板数量",
    openFarmDetails: (name: string) => `打开 ${name} 详情`,
    learnMore: "了解更多",
    readFullBlog: "阅读完整博客",
    ...
    endowment: "捐赠基金",
    tradingBot: "交易机器人",
    revenueContribution: "收入贡献",
    last90Days: "最近 90 天",
    noRegionData: "暂无区域数据。",
    liveBreakdownUnavailable: "实时构成数据不可用。",
    activeDelegators: "活跃委托人",
    networkImpact: "网络影响力",
    networkImpactDesc:
      "Glow 太阳能装置的综合环境产出。",
    homesPoweredByCleanEnergy: "由清洁能源供电的家庭数",
    totalPanels: "面板总数",
    installedCapacity: "装机容量",
    treesEquivalent: "等效树木数",
    fullyDilutedValuation: "全稀释估值",
    tokenFdvDesc: "不含内嵌流动性 GLW 的代币 FDV。",
    tokenCategoryLabels: {
      solarFarms: "太阳能电站",
      grants: "拨款",
      governance: "治理",
      ecosystem: "生态系统",
      earlyStageFunding: "早期融资",
      lateStageFunding: "后期融资",
      grantsBootstrap: "拨款启动",
      earlyLiquidityBootstrap: "流动性启动",
    } as Record<string, string>,
  },
} as const;
